...
const translations: Record<Language, Record<string, TranslationValue>> = {
  en: {
    ...
    "action.becomeObserver": "Become observer",
    "action.becomeVoter": "Become voter",
    ...
    "action.skip": "Skip",
    "action.sync": "Sync",
    "action.transferOwnership": "Make host",
    ...
    "notice.observerMode": "You are now an observer.",
    "notice.voterMode": "You can vote again.",
    "notice.ownershipTransferred": "Host role transferred.",
  ...
  ru: {
    ...
    "action.becomeObserver": "Стать наблюдателем",
    "action.becomeVoter": "Голосовать",
    ...
    "action.transferOwnership": "Сделать хостом",
    ...
    "notice.observerMode": "Вы теперь наблюдатель.",
    "notice.voterMode": "Вы снова можете голосовать.",
    "notice.ownershipTransferred": "Роль хоста передана.",
    "notice.roomCreated": "Комната создана.",
    "participant.host": "Хост",
